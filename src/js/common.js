...
if (/Android|webOS|iPad|iPhone|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) {
  ...
  var vapScroll = $('.messenger').clone().addClass('messenger_scroll')

  var buttonHeader = $('.header__buttons .button_gold').clone().addClass('button_scroll')
  ...
  $(document).scroll(function () {
    ...
    if (scrollTop > 100) {
      ...
      vapScroll.appendTo(boxFixed)
      buttonHeader.appendTo(boxFixed)
...
if (/Android|webOS|iPhone|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i.test(navigator.userAgent)) {
  ...
  var eventSubtitle = $('.event__subtitle')
  eventSubtitle.eq(0).hide()
